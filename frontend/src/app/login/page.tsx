    ...
    <main className="min-h-screen bg-[#faf8f5] flex items-center justify-center px-6 login-page">
      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {mode === "login" && (
            <div className="text-right">
              <button
                type="button"
                onClick={() => showNotice("La recuperación de contraseña estará disponible muy pronto. Escríbenos si necesitas acceso.")}
                className="text-[12px] text-[#999] hover:text-[#1a1a1a] transition-colors duration-300"
              >
          ...
          {notice && (
            <div className="px-4 py-3 rounded-xl bg-[#b8860b]/[0.07] border border-[#b8860b]/20">
              <p className="text-[12px] text-[#8a6508] font-medium leading-[1.6]">{notice}</p>
            </div>
          )}
        ...
        <div className="flex gap-3">
          <button
            onClick={() => showNotice("El acceso con Google estará disponible próximamente.")}
            className="flex-1 flex items-center justify-center gap-2.5 bg-white border border-[#e5e0db] rounded-xl py-3.5 hover:border-[#1a1a1a]/30 hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-all duration-300">
          ...
          <button
            onClick={() => showNotice("El acceso con Apple estará disponible próximamente.")}
            className="flex-1 flex items-center justify-center gap-2.5 bg-white border border-[#e5e0db] rounded-xl py-3.5 hover:border-[#1a1a1a]/30 hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-all duration-300">
        ...
        <p className="text-center text-[11px] text-[#ccc] mt-12 leading-[1.8]">
          Al continuar, aceptas los <span className="text-[#999]">terminos de uso</span> y la <span className="text-[#999]">politica de privacidad</span>.
        </p>
      </div>
