...
function getAIResponse(input: string): string {
  ...
  if (lower.includes("brent") || lower.includes("petroleo") || lower.includes("oil")) {
    return "El **Brent** es el precio de referencia del petroleo crudo en Europa y buena parte del mundo (el equivalente en EEUU es el WTI).\n\nAhora mismo esta cayendo por las negociaciones Iran-EEUU. Si Iran vuelve al mercado con plena capacidad, anadira ~1.5M barriles/dia, lo que presionaria el precio a la baja.\n\nTu posicion en BRT esta siendo afectada directamente. El paralelo historico de 2015 (JCPOA) es preocupante: entonces el Brent cayo un 30% en 6 meses.";
  }
