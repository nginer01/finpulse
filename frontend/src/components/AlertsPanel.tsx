...
const mockAlerts: Alert[] = [
  {
    ...
    description: "Brent Crude ha caido por debajo de $74. Próximo soporte en $72. Tu posición pierde -3.8% esta semana.",
    time: "Hace 2h",
    read: false,
  },
  {
    ...
    description: "VIX en 13.2 — históricamente, niveles sub-14 durante +2 semanas preceden correcciones del 3-5%.",
    time: "Hace 5h",
    read: false,
  },
  {
    id: "3",
    type: "info",
    title: "Nueva recomendación: reducir BRT",
    description: "Convicción 8/10. Negociaciones Iran avanzan. Considerar reducir posición un 50%.",
    time: "Hace 8h",
    read: false,
  },
  {
    ...
    description: "Tu mejor posición esta semana. El ciclo de semiconductores se confirma tras evento Nvidia.",
    time: "Hace 1d",
    read: true,
  },
  {
    ...
    description: "Evento clave para tu posición en SEMI. Puede confirmar o desmentir el ciclo expansivo.",
    time: "Hace 1d",
    read: true,
  },
  {
